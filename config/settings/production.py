...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["sis.eivl.io"]
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="School Information System <noreply@sis.eivl.io>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[School Information System]"
)
